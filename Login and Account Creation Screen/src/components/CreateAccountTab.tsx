...
import { EyeIcon, EyeOffIcon, MapPinIcon, BuildingIcon, ChevronDownIcon } from "./Icons";
import { supabase } from "../lib/supabase";

type Role = "field-officer" | "district-officer" | null;
...
export default function CreateAccountTab() {
  ...
  const submit = async (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!fullName.trim() || !email.trim() || !district || !password || !confirmPassword || !selectedRole) {
